...
Partial Public Class TaskUserLog
    ...
    Public Overridable Property TaskUserLogAttachment As ICollection(Of TaskUserLogAttachment) = New HashSet(Of TaskUserLogAttachment)
