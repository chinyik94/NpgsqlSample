...
Partial Public Class PatientAMT
    Public Property PatientAMTID As Integer
    ...
    Public Overridable Property PatientAMTAnswer As ICollection(Of PatientAMTAnswer) = New HashSet(Of PatientAMTAnswer)
