...
Partial Public Class APIOrder
    ...
    Public Overridable Property APIOrderAllergy As ICollection(Of APIOrderAllergy) = New HashSet(Of APIOrderAllergy)
    Public Overridable Property APIOrderDiagnosis As ICollection(Of APIOrderDiagnosis) = New HashSet(Of APIOrderDiagnosis)
    Public Overridable Property APIOrderMedication As ICollection(Of APIOrderMedication) = New HashSet(Of APIOrderMedication)
    Public Overridable Property APIOrderTask As ICollection(Of APIOrderTask) = New HashSet(Of APIOrderTask)
